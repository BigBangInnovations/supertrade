...
export const isRetailer = createSelector(
    selectAuthState,
    auth => auth.isRetailer
);

export const isDistributor = createSelector(
    selectAuthState,
    auth => auth.isDistributor
);
...
export const getSalesActiveScheme = createSelector(
    selectAuthState,
    auth => auth.activeSalesSchemeId
);

export const getPurchaseActiveScheme = createSelector(
    selectAuthState,
    auth => auth.activePurchaseSchemeId
);
...
export const currentUser = createSelector(
    selectAuthState,
    auth => (auth.user != undefined)?JSON.parse(auth.user):[]
);
