...
import { Sale, UserPointsStatus } from '../../../../core/sales';
...
export class BaseDataSource implements DataSource<BaseModel> {
	...
	userPointsSubject = new BehaviorSubject<any>([]);
	userPoints$: Observable<any[]>;
	hasItems: boolean = false;//true; // Need to show message: 'No records found'
	...
	constructor() {
		...
		this.userPoints$ = this.userPointsSubject.asObservable();
	...
	disconnect(collectionViewer: CollectionViewer): void {
		...
		this.userPointsSubject.complete();
