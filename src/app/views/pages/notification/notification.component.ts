...
export class NotificationComponent implements OnInit, OnDestroy {
  ...
  loadNotificationTab() {
    ...
    httpParams = httpParams.append('type',`${APP_CONSTANTS.NOTIFICATION_TYPE.SUPERSALES_ORDER},${APP_CONSTANTS.NOTIFICATION_TYPE.SUPERTRADE_DISTRIBUTOR_ADD_SALES},${APP_CONSTANTS.NOTIFICATION_TYPE.SUPERTRADE_RETAILER_PURCHASE_RETURN},${APP_CONSTANTS.NOTIFICATION_TYPE.SUPERTRADE_RETAILER_PARTIAL_PURCHASE_REQUEST},${APP_CONSTANTS.NOTIFICATION_TYPE.SUPERTRADE_DISTRIBUTOR_PARTIAL_PURCHASERETUN_REQUEST},${APP_CONSTANTS.NOTIFICATION_TYPE.SUPERTRADE_DISTRIBUTOR_ADD_SALES_RETURN},${APP_CONSTANTS.NOTIFICATION_TYPE.SUPERTRADE_DISTRIBUTOR_ADD_PO},${APP_CONSTANTS.NOTIFICATION_TYPE.SUPERTRADE_DISTRIBUTOR_ADD_PURCHASE},${APP_CONSTANTS.NOTIFICATION_TYPE.SUPERTRADE_DISTRIBUTOR_PURCHASE_RETURN}`);
